...
// Sección 5 del documento: Productos, Clientes, KPIs, Agentes, Campañas
...
export const DATA = {
  ...
  // Jerarquía B2B: Empresa → Contactos Clave (Sección 5 datos maestros)
  clients: [
    {
      id: 1,
  ...
  // Agentes y Supervisores (Sección 5 datos maestros)
  agents: [
  ...
  // Matriz de KPIs completa — Sección 5 del documento
  kpis: [
    {
      id: 'kpi-conversion',
      category: 'Ventas',
      ...
      value: '24%',
      formula: 'Oportunidades cerradas / oportunidades totales',
      description: 'Cotizaciones aprobadas vs total generadas',
    },
    {
      id: 'kpi-effective-calls',
      category: 'Productividad',
      label: 'Llamadas Efectivas por Agente',
      value: '68%',
      formula: 'Llamadas con contacto / total llamadas',
      description: 'Ratio de contacto efectivo sobre marcaciones',
    },
    {
      id: 'kpi-closing-time',
      category: 'Tiempo',
      ...
      value: '14 días',
      formula: 'Días desde contacto inicial hasta cierre',
      description: 'Media de días en ciclo de venta completo',
    },
    {
      id: 'kpi-total-sales',
      category: 'Financiero',
      ...
      value: '$124,500',
      formula: 'Suma de montos de cotizaciones cerradas (APROBADA)',
      description: 'Monto acumulado de cierres en el período',
    },
    {
      id: 'kpi-quote-approval',
      category: 'Calidad',
      label: 'Cotizaciones Aprobadas',
      value: '72%',
      formula: 'Cotizaciones aprobadas / cotizaciones enviadas a aprobación',
      description: 'Tasa de aprobación en flujo de supervisión',
    },
  ],

  // Etapas del pipeline de oportunidades (Sección 2)
  opportunityStages: [
